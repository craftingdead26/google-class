...
function showLeaderboard() {
    ...
    let urlDefaultAvatar = "https://cdn.jsdelivr.net/gh/genizy/google-class/numbers/EccentricData/Icons/icon_player.png";
    let modalHtml = `<div id="modal-leaderboard">
        <div id="modal-leaderboard-top">
            <div class="title">${title}</div>
            <img src="https://cdn.jsdelivr.net/gh/genizy/google-class/numbers/EccentricData/Icons/btn_close.png" class="modal-content-top-btn-close">
        </div>
